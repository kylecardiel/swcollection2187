import { create, read, updateRecord, deleteRecord } from 'shared/api/orchestrator';
...
export class UserApi {
    ...
    static update = (userId, location, recordId, record) => updateRecord(`${USERS}${userId}/${location}${recordId}`, record);
